...
\item Different passing threshold: {\bf 20 points (team of 2), 18 points (team of 1)}
...
BFH's official Jitsi server {\bf bfh.meet.switch.ch} will be
primarily used for voice conferencing, including
interactive help with the project. The server is
